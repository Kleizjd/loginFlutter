...
class CustomIconDecoration extends Decoration{
  ...
  CustomIconDecoration({@required Color colorLine, @required double iconSize,
    @required double lineWidth,
    @required bool firstData,
    @required bool lastData}) : this.colorLine = colorLine,
                                this.iconSize = iconSize,
                                this.lineWidth = lineWidth, this.firstData = firstData, this.lastData = lastData;


  @override
  BoxPainter createBoxPainter([onChanged]) {
    // TODO: implement createBoxPainter
    return IconLine(colorLine: colorLine, iconSize: iconSize, lineWidth: lineWidth, firstData: firstData, lastData: lastData);
  }
...
class IconLine extends BoxPainter {
  ...
  IconLine({
    ...
    @required double lineWidth,
    @required bool firstData,
    @required bool lastData}) : this.colorLine = colorLine, this.iconSize = iconSize, this.firstData = firstData, this.lastData = lastData,
        paintLine = Paint()
          ..color = colorLine
